...
from clients.extended_clients.extended_clients import BinanceCli, BitfinexCli
...
class DataScraper:
    ...
    def get_cli(self, exchange, *args, **kwargs):
        ...
        if exchange == 'bitfinex':
            return BitfinexCli(*args, **kwargs)
...
if __name__ == "__main__":
    ...
    # DataScraper().get_dataset(exchange="bitfinex", market="BTC/USDT", start)
